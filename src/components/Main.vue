      ...
      <el-col :span="4" class="userinfo">
        <el-dropdown trigger="hover">
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item><i class="fa fa-user"></i> 个人资料</el-dropdown-item>
            <el-dropdown-item><i class="fa fa-cog"></i> 设置 </el-dropdown-item>
            <el-dropdown-item divided @click.native="logout"><i class="fa fa-sign-out"></i> 注销 </el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
      </el-col>
    </el-col>
      ...
      <aside :class="collapsed ? 'menu-collapsed' : 'menu-expanded'">
        ...
        <el-menu :default-active="$route.path" @open="handleOpen" @close="handleClose" @select="handleSelect" unique-opened router v-show="!collapsed">
          <template v-for="(item,index) in $router.options.routes" v-if="!item.hidden">
            ...
            <el-menu-item v-if="item.rootNode && item.children.length>0" :index="item.children[0].path">
              <i :class="item.children[0].iconClass"></i>
